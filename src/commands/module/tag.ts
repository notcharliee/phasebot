...
export default Functions.clientSlashCommand({
  ...
  async execute(client, interaction) {
    ...
    const tagsSchema = await Database.Tags.findOne({ guild: interaction.guildId }) ?? await new Database.Tags({
    ...
    switch (interaction.options.getSubcommand()) {
      ...
      case 'add': {
        ...
        if (tagIndex != -1) return Functions.clientError(
          interaction,
          'No can do!',
        ...
        interaction.reply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setTitle(Enums.PhaseEmoji.Success + 'Tag Added')
          ],
        })
        ...
        interaction.reply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setTitle(Enums.PhaseEmoji.Success + 'Tag Edited')
          ],
        })
      ...
      case 'get': {
        ...
        if (!tag) return Functions.clientError(
          interaction,
          'No can do!',
          'No tag exists with that name.'
        )
        ...
        interaction.reply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setTitle(Enums.PhaseEmoji.Success + 'Tag Removed')
          ],
        })
